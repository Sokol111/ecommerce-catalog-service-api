...
var jsonFieldsNameOfAttributeOptionInput = [4]string{
	0: "name",
	1: "slug",
	2: "colorCode",
	3: "sortOrder",
...
var jsonFieldsNameOfAttributeValue = [6]string{
	0: "attributeId",
	1: "optionSlugValue",
	2: "optionSlugValues",
	3: "numericValue",
...
// encodeFields encodes fields.
func (s *AttributeValueInput) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("attributeId")
...
var jsonFieldsNameOfAttributeValueInput = [6]string{
	0: "attributeId",
	1: "optionSlugValue",
	2: "optionSlugValues",
	3: "numericValue",
...
func (s *AttributeValueInput) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode AttributeValueInput to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode AttributeValueInput")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfAttributeValueInput) {
					name = jsonFieldsNameOfAttributeValueInput[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
func (s *CreateProductRequest) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "attributes":
			if err := func() error {
				s.Attributes = make([]AttributeValueInput, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem AttributeValueInput
					if err := elem.Decode(d); err != nil {
						return err
					}
					s.Attributes = append(s.Attributes, elem)
...
// Encode encodes DeleteProductForbidden as json.
func (s *DeleteProductForbidden) Encode(e *jx.Encoder) {
	unwrapped := (*Problem)(s)

	unwrapped.Encode(e)
}

// Decode decodes DeleteProductForbidden from json.
func (s *DeleteProductForbidden) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DeleteProductForbidden to nil")
	}
	var unwrapped Problem
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DeleteProductForbidden(unwrapped)
	return nil
}

// MarshalJSON implements stdjson.Marshaler.
func (s *DeleteProductForbidden) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *DeleteProductForbidden) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// Encode encodes DeleteProductNotFound as json.
func (s *DeleteProductNotFound) Encode(e *jx.Encoder) {
	unwrapped := (*Problem)(s)

	unwrapped.Encode(e)
}

// Decode decodes DeleteProductNotFound from json.
func (s *DeleteProductNotFound) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DeleteProductNotFound to nil")
	}
	var unwrapped Problem
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DeleteProductNotFound(unwrapped)
	return nil
}

// MarshalJSON implements stdjson.Marshaler.
func (s *DeleteProductNotFound) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *DeleteProductNotFound) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes DeleteProductUnauthorized as json.
func (s *DeleteProductUnauthorized) Encode(e *jx.Encoder) {
	unwrapped := (*Problem)(s)

	unwrapped.Encode(e)
}

// Decode decodes DeleteProductUnauthorized from json.
func (s *DeleteProductUnauthorized) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode DeleteProductUnauthorized to nil")
	}
	var unwrapped Problem
	if err := func() error {
		if err := unwrapped.Decode(d); err != nil {
	...
	*s = DeleteProductUnauthorized(unwrapped)
	return nil
}

// MarshalJSON implements stdjson.Marshaler.
func (s *DeleteProductUnauthorized) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *DeleteProductUnauthorized) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
var jsonFieldsNameOfUpdateAttributeRequest = [6]string{
	0: "id",
	1: "name",
	2: "unit",
	3: "enabled",
